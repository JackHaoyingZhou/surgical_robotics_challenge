...
##### for data0
file_task = 'data/data0/data0_train_error3.pickle'
...
r0 = R.from_quat(ori_list[0])
T_f0[0:3, 0:3] = r0.as_matrix()
T_f0[0:3, 3] = pos_list[0]
T_f_frame0 = convert_mat_to_frame(T_f0)
ik_sol0 = compute_IK(T_f_frame0)
ik_sol0 = enforce_limits(ik_sol0)
ik_sol0.append(0.0)


#### for data 0-2
for j in range(400):
    jp_value.append(ik_sol0)
...
with open('data/data0/data0_regen_error3.pickle','wb') as fp:
